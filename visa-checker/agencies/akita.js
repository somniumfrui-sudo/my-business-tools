...
(function(){
  const data = [
    { name: "国際人材開発協同組合", type: "登録支援機関", address: "秋田県秋田市山王二丁目７番３６号　山王ソラリスビル３階", tel: "0188381428", visa: ["tokutei1"], prefId: "akita", districtId: "akita-1" },
    { name: "株式会社メディコサービス", type: "登録支援機関", address: "秋田県湯沢市小野字東堺８４－２", tel: "0183523005", visa: ["tokutei1"], prefId: "akita", districtId: "akita-2" },
    { name: "株式会社総合医療福祉サービス", type: "登録支援機関", address: "秋田県秋田市千秋矢留町６番２５号", tel: "0188840611", visa: ["tokutei1"], prefId: "akita", districtId: "akita-1" },
    ...
    { name: "株式会社ワンステップイースト", type: "登録支援機関", address: "秋田県秋田市中通三丁目４－４７チサンマンション秋田２１０", tel: "05037086502", visa: ["tokutei1"], prefId: "akita", districtId: "akita-1" },
    { name: "株式会社ワンステップイースト", type: "登録支援機関", address: "秋田県潟上市昭和大久保字街道下２４番地", tel: "0188777485", visa: ["tokutei1"], prefId: "akita", districtId: null },
    { name: "株式会社ワンステップイースト", type: "登録支援機関", address: "秋田県秋田市八橋大畑二丁目３番１号WhiteCube１F", tel: "0188386943", visa: ["tokutei1"], prefId: "akita", districtId: "akita-1" },
    { name: "株式会社ワンステップイースト", type: "登録支援機関", address: "秋田県能代市二ツ井町字稗川原７９番地４５", tel: "0185710005", visa: ["tokutei1"], prefId: "akita", districtId: null },
    { name: "株式会社ワンステップイースト", type: "登録支援機関", address: "秋田県秋田市土崎港中央三丁目４番１３号", tel: "0188537689", visa: ["tokutei1"], prefId: "akita", districtId: "akita-1" },
    ...
    { name: "株式会社ワンステップイースト", type: "登録支援機関", address: "秋田県秋田市寺内堂ノ沢三丁目６番１６号", tel: "0188116784", visa: ["tokutei1"], prefId: "akita", districtId: "akita-1" },
    { name: "株式会社ワンステップイースト", type: "登録支援機関", address: "秋田県能代市落合字中大野１１５番地４１", tel: "08082055833", visa: ["tokutei1"], prefId: "akita", districtId: null },
    { name: "株式会社ワンステップイースト", type: "登録支援機関", address: "秋田県秋田市大町一丁目３番８号秋田ディライトビル５階", tel: "0188386455", visa: ["tokutei1"], prefId: "akita", districtId: "akita-1" },
    { name: "株式会社ワンステップイースト", type: "登録支援機関", address: "秋田県秋田市山王中園町１０番２号", tel: "0188831355", visa: ["tokutei1"], prefId: "akita", districtId: "akita-1" },
    { name: "株式会社ワンステップイースト", type: "登録支援機関", address: "秋田県秋田市中通２丁目２番３２号山二ビル７階", tel: "0188534615", visa: ["tokutei1"], prefId: "akita", districtId: "akita-1" },
    { name: "株式会社ワンステップイースト", type: "登録支援機関", address: "秋田県能代市二ツ井町字太田面１５番地１３", tel: "0185736444", visa: ["tokutei1"], prefId: "akita", districtId: null },
    { name: "株式会社ワンステップイースト", type: "登録支援機関", address: "秋田県秋田市飯島字堀川１０番地", tel: "07022315515", visa: ["tokutei1"], prefId: "akita", districtId: "akita-1" },
    ...
    { name: "株式会社ワンステップイースト", type: "登録支援機関", address: "秋田県湯沢市三梨町下猿城３７番地１号", tel: "09092193398", visa: ["tokutei1"], prefId: "akita", districtId: "akita-2" },
